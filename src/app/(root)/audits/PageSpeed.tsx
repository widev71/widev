...
export default function PageSpeed() {
  ...
  const ENDPOINT = `https://www.googleapis.com/pagespeedonline/v5/runPagespeed?url=https://widev.vercel.app${path}&key=${process.env.NEXT_PUBLIC_PAGESPEED_API_KEY}${PAGESPEED_CATEGORIES}`;
  ...
  return (
    <section className="m-auto w-fit">
      ...
      >
        <span className="gradient__text inline-block">
          widev.vercel.app
        </span>{" "}
        performance
      </motion.h2>
